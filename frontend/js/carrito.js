...
/* function agregarAlCarritoClicked(event){
    ...
    var id = button.getAttribute('data-id'); // Get the product ID
...
function agregarItemAlCarrito(titulo, precio, imagenSrc, id) {
    ...
    for (var i = 0; i < idsItemsCarrito.length; i++) {
        console.log(`Comparando ID: ${idsItemsCarrito[i].innerText} con ${id}`); // Debugging log
...
function actualizarTotalCarrito() {
    ...
    for (var i = 0; i < carritoItems.length; i++) {
        ...
        // Obtenemos el precio directamente como decimal
